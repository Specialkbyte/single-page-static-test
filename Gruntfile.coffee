module.exports = (grunt) ->
  ...
  grunt.registerTask "basehtml:deployed", ["jade", "targethtml:deployed"]
  grunt.registerTask "basehtml:prod", ["jade", "targethtml:prod"]

  grunt.registerTask "deploy", ["concurrent:build", "requirejs", "cssmin:deploy", "uglify:deploy", "basehtml:deployed"]
